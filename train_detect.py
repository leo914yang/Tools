...
def train():
    ...
    os.system(f"python {path + 'train.py'} --batch {batch} --cfg {path + 'cfg/training/' + cfg} --img 320 --epochs {epoch} --data {path + 'Teammate/data.yaml'} --weights '/Users/leo/git_workspace/yolov7/yolov7.pt' --name yolov7_test --hyp {path + 'data/hyp.scratch.p5.yaml'} --device {device}")
